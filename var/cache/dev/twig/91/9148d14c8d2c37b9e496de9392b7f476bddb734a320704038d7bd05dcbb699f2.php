...
class __TwigTemplate_138b4f991f6614443c8b386bdbf832bd3f494d1f77c882e9bd3fcad7b57a6b48 extends Template
{
    private $source;
    private $macros = [];
...
<body class=\"no-trans\">
    ...
    ";
        ...
        echo "
    <button class=\"btn btn-primary\"  role=\"button\" class=\"btn\">";
        // line 7
...
<body class=\"no-trans\">
    <div class=\"container\">
        <div class=\"row\">\t\t\t\t\t 
          <div style=\"background-color:aqua!important; margin-top: 0px; opacity: 0.8!important;\" data-animation-effect=\"fadeIn\">{{ form_start(form) }}
    {{ form_widget(form) }}
    <button class=\"btn btn-primary\"  role=\"button\" class=\"btn\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
</div>
</div>
</div>           
</body>", "cours/_form.html.twig", "C:\\xampp\\htdocs\\Cbe\\templates\\cours\\_form.html.twig");
    }
}

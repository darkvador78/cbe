...
class __TwigTemplate_f3fd4e4af90b7a56aab17dfe53f482c637dc9d78f63abadb142bb82fe660221c extends Template
{
    private $source;
    private $macros = [];
...
{{ form_start(form) }}
    {{ form_widget(form) }}
    <button class=\"btn btn-primary\"  role=\"button\">{{ button_label|default('Save') }}</button>
{{ form_end(form) }}
</div>
</div>
</div>           
</body>", "category/_form.html.twig", "C:\\xampp\\htdocs\\Cbe\\templates\\category\\_form.html.twig");
    }
}
